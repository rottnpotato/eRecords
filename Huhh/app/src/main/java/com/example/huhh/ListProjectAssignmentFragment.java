 ...
 * Use the {@link ListProjectAssignmentFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ListProjectAssignmentFragment extends Fragment {
    ...
    public ListProjectAssignmentFragment(String subjectItem, String sectionItem, FragmentManager manager, FloatingActionButton fab, AlertDialog dialog, View views, ImageView imageView) {
    ...
    public static ListProjectAssignmentFragment newInstance(String param1, String param2, String sectionItem, String subjectItem, FragmentManager manager, FloatingActionButton fab, AlertDialog dialog, View views, ImageView imageView) {
        ListProjectAssignmentFragment fragment = new ListProjectAssignmentFragment(subjectItem,sectionItem,manager,fab,dialog, views, imageView);
    ...
    private void gotoItemActivity(int position) {
        ...
        fragmentTransaction.replace(R.id.frame_layout, new ProjectAssignmentInfoFragment(name,section,positioner));
