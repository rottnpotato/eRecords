 ...
 * Use the {@link ListMajorExamFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ListMajorExamFragment extends Fragment {
    ...
    public ListMajorExamFragment(String subjectItem, String sectionItem, FragmentManager manager, FloatingActionButton fab, AlertDialog dialog, View views, ImageView imageView) {
    ...
    public static ListMajorExamFragment newInstance(String param1, String param2, String sectionItem, String subjectItem, FragmentManager manager, FloatingActionButton fab, AlertDialog dialog, View views, ImageView imageView) {
        ListMajorExamFragment fragment = new ListMajorExamFragment(subjectItem,sectionItem,manager,fab,dialog, views, imageView);
    ...
    private void gotoItemActivity(int position) {
        ...
        fragmentTransaction.replace(R.id.frame_layout, new MajorExamInfoFragment(name,section,positioner));
