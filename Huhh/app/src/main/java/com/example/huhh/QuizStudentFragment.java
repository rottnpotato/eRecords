 ...
 * Use the {@link QuizStudentFragment#newInstance} factory method to
...
public class QuizStudentFragment extends Fragment {
    ...
    public QuizStudentFragment(String subjectItem, String sectionItem, FragmentManager manager, FloatingActionButton fab, AlertDialog dialog, View views, ImageView imageView) {
    ...
    public static QuizStudentFragment newInstance(String param1, String param2, String sectionItem, String subjectItem, FragmentManager manager, FloatingActionButton fab, AlertDialog dialog, View views, ImageView imageView) {
        QuizStudentFragment fragment = new QuizStudentFragment(subjectItem,sectionItem,manager,fab,dialog, views, imageView);
    ...
    private void addToQuizTable(ArrayList<QuizAddItem> quizAddItems,View view,Dialog dialog){
        ...
        dbaddHandler = new DBaddHandler(view.getContext());
            int response = dbaddHandler.insertQuiz(quizAddItems);
            if (response == 1)
                Toast.makeText(view.getContext(), "Added Quizzes Successfully!", Toast.LENGTH_LONG).show();
            else
                Toast.makeText(view.getContext(), "Adding Quizzes Failed!", Toast.LENGTH_LONG).show();
            dialog.dismiss();
    }
