 ...
 * Use the {@link ProjectAssignmentInfoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ProjectAssignmentInfoFragment extends Fragment {
    ...
    public ProjectAssignmentInfoFragment(String name, String section, int position) {
    ...
    public static ProjectAssignmentInfoFragment newInstance(String param1, String param2, String name, String section, int position) {
        ProjectAssignmentInfoFragment fragment = new ProjectAssignmentInfoFragment(name,section,position);
    ...
    private void setStudentDetails(View view,String name, String section){
        ...
        students=dbaddHandler.projAssignmentDetails(section,name);
