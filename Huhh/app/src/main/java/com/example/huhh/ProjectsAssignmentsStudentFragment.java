 ...
 * Use the {@link ProjectsAssignmentsStudentFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ProjectsAssignmentsStudentFragment extends Fragment {
    ...
    public ProjectsAssignmentsStudentFragment(String subjectItem, String sectionItem, FragmentManager manager, FloatingActionButton fab, AlertDialog dialog, View views, ImageView imageView) {
    ...
    public static ProjectsAssignmentsStudentFragment newInstance(String param1, String param2, String sectionItem, String subjectItem, FragmentManager manager, FloatingActionButton fab, AlertDialog dialog, View views, ImageView imageView) {
        ProjectsAssignmentsStudentFragment fragment = new ProjectsAssignmentsStudentFragment(subjectItem,sectionItem,manager,fab,dialog, views, imageView);
    ...
    private void addToQuizTable(ArrayList<QuizAddItem> quizAddItems,View view,Dialog dialog){
        ...
        dbaddHandler = new DBaddHandler(view.getContext());
            int response = dbaddHandler.insertProjAssignment(quizAddItems);
            if (response == 1)
                Toast.makeText(view.getContext(), "Added Projects/Assignments Successfully!", Toast.LENGTH_LONG).show();
            else
                Toast.makeText(view.getContext(), "Adding Projects/Assignments Failed!", Toast.LENGTH_LONG).show();
            dialog.dismiss();
    }
