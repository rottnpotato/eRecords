 ...
 * Use the {@link MajorExamInfoFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MajorExamInfoFragment extends Fragment {
    ...
    public MajorExamInfoFragment(String name, String section, int position) {
    ...
    public static MajorExamInfoFragment newInstance(String param1, String param2, String name, String section, int position) {
        MajorExamInfoFragment fragment = new MajorExamInfoFragment(name,section,position);
    ...
    private void setStudentDetails(View view,String name, String section){
        ...
        students=dbaddHandler.majorExamDetails(section,name);
