 ...
 * Use the {@link GradeInfoFragment#newInstance} factory method to
...
public class GradeInfoFragment extends Fragment {
    ...
    public GradeInfoFragment(String name, String section, int position) {
    ...
    public static GradeInfoFragment newInstance(String param1, String param2, String name, String section, int position) {
        GradeInfoFragment fragment = new GradeInfoFragment(name,section,position);
