 ...
 * Use the {@link ListQuizesFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ListQuizesFragment extends Fragment {
    ...
    public ListQuizesFragment(String subjectItem, String sectionItem, FragmentManager manager, FloatingActionButton fab, AlertDialog dialog, View views, ImageView imageView) {
    ...
    public static ListQuizesFragment newInstance(String param1, String param2, String sectionItem, String subjectItem, FragmentManager manager, FloatingActionButton fab, AlertDialog dialog, View views, ImageView imageView) {
        ListQuizesFragment fragment = new ListQuizesFragment(subjectItem,sectionItem,manager,fab,dialog, views, imageView);
